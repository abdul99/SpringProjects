...
public class UserController {
	...
	public ResponseEntity<UserDetails> findById(@PathVariable(value = "id") Long id) {
	...
	public ResponseEntity<UserDetails> findById(@PathVariable(value = "email") String email) {
